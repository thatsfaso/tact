...
|---|---|
| `animals` | Any animal, real or fictional |
| `vehicles` | Boats, cars, planes, trains, rockets, bikes |
| `nature` | Trees, flowers, sun, moon, stars, clouds, mountains, water |
| `buildings` | Houses, castles, lighthouses, towers |
| `people` | Human figures (no facial detail — too small for tactile) |
| `objects` | Hats, books, crowns, food, tools, toys |
